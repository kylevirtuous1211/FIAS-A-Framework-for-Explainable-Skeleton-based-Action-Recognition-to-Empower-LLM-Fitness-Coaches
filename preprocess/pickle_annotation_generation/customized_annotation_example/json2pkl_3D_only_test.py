...
if __name__ == '__main__':
    ...
    parser.add_argument('--json_root', default='../data/json/json_OOD_test_3D', help='Root directory of JSON files (e.g., data/json)')
    ...
    parser.add_argument('--out_pkl', default='../data/pickle/json_OOD_test_3D_without_idle.pkl', help='Output path for the .pkl file (e.g., data/custom_data.pkl)')
