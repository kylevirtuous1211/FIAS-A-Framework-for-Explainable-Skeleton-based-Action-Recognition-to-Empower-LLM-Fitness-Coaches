...
if __name__ == '__main__':
    ...
    parser.add_argument('--json_root', default='/home/cvlab123/data/json/json_friend_test', help='Root directory of JSON files (e.g., data/json)')
    parser.add_argument('--out_pkl', default='../data/pickle/friend_test.pkl', help='Output path for the .pkl file (e.g., data/custom_data.pkl)')
